...
@section('title', curd_index_title('PkgBlog::comment'))
@section('content')
    <div class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>
                        {{ curd_index_title('PkgBlog::comment') }}
                    </h1>
                </div>
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        @can('create-CommentController')
                            <a href="{{ route('comments.create') }}" class="btn btn-info">
