...
<form action="{{ $item->id ? route('tags.update', $item->id) : route('tags.store') }}" method="POST">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input name="name" type="input" class="form-control" id="name" placeholder="Entrez {{__('PkgBlog::tag.name')}}"
        ...
        <div class="form-group">
            ...
            <input name="slug" type="input" class="form-control" id="slug" placeholder="Entrez {{__('PkgBlog::tag.slug')}}"
